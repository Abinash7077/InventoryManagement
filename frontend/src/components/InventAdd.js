...
const InventAdd = () => {
  ...
  const handleConsumption = async () => {
    try {
      ...
      if (item.unit ) {
        convertedQuantity = quantity; // Convert grams to kilograms
      }
  ...
  return (
    <div className="container ">
      <h2 className='text-center'>Inventory Addition</h2>
      <div className="mb-3">
      ...
      <button className="btn btn-primary" onClick={handleConsumption}>Addition Item</button>
    </div>
  );
};
